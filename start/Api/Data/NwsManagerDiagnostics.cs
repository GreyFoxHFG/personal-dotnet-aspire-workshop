...
{
    public const string MeterName = "NwsManagerMetrics";
    public const string TracingSourceName = "NwsManager";
    ...
    public static readonly ActivitySource activitySource = new(TracingSourceName);
}